...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if efficiency_ratio >= 80:
        return 'green'
    elif efficiency_ratio < 80 and efficiency_ratio >= 60:
        return 'orange'
    elif efficiency_ratio < 60 and efficiency_ratio >= 30:
        return 'red'
    else:
        return 'black'
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if (temperature * neutrons_produced_per_second) < 0.9 * threshold:
        return 'LOW'
    elif (temperature * neutrons_produced_per_second) > threshold * (1 - 0.1)  and (temperature * neutrons_produced_per_second) < threshold * (1 + 0.1):
        return 'NORMAL'
    else:
        return 'DANGER'
