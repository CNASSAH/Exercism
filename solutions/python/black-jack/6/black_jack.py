...
def is_blackjack(card_one, card_two):
    ...
    if card_one != 'A' and card_two != 'A':
        return False
    if 1 < value_of_card(card_one) < 10 or 1 < value_of_card(card_two) < 10 :
        return False
    if value_of_card(card_one) + value_of_card(card_two) == 2: 
        return False
    else:
        return True
...
def can_split_pairs(card_one, card_two):
   ...
   Returns:
    ...
    if value_of_card(card_one) >= 10 and value_of_card(card_two) >= 10:
        return True
    elif isinstance(higher_card(card_one,card_two), tuple):
        return True
    return False
